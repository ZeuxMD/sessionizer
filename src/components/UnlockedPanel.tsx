    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      <div className="bg-slate-800 rounded-2xl p-8 shadow-2xl max-w-lg w-full text-center">
        <div className="flex items-center justify-center mb-6">
          ...
          >
            <path
              ...
              strokeWidth={2}
              d="M9 12l2 2 4-4m5.586-3.586A2 2 0 0018.172 5H5.828a2 2 0 00-1.414.586A2 2 0 004 7v10a2 2 0 002 2h12a2 2 0 002-2V7a2 2 0 00-.586-1.414z"
            />
          </svg>
        </div>
        ...
        <p className="text-slate-400 mb-8">
          Sessionizer is idle. Use the controls below or close the window to
